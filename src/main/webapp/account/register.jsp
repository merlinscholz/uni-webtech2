...
<main>
    ...
    <div class="wrapper" style="margin-top:-180px;">
        <form id="registerForm" action="#" method="POST" class="register-form">
            ...
            <span id="usernameerror" class="errormessage">Username is empty or this username is already taken!</span>
            <input type="password" id="password" name="password" placeholder="Password">
            <span id="passworderror" class="errormessage">Password cannot be empty!</span>
            <input type="password" id="password2" name="password2" placeholder="Confirm Password">
            <span id="password2error" class="errormessage">Both passwords have to be identical!</span>
...
<div class="alertbg" id="alertbg"></div>
<div class="alert" id="successAlert">
    <span>Success!</span>
    <p>Account successfully created! You can log in to it now.</p>
    <a href="login.jsp" class="alertclosebtn">Login</a>
</div>
<script>
    ...
    var usernameCheck = function(){
        if(username.value===""){
            ...
            xhttp.open("HEAD","http://127.0.0.1:8080/tudo/api/users/"+username.value,true);
            xhttp.send();
        }
    };
    ...
    var password2Check = function(){
        if(password2.value!==password.value){
            ...
            password2Error.classList.remove("error");
        }
    };
    ...
    var register = function(e){
        ...
        if(!username.classList.contains("error")&&
            ...
            var passwordHash = sjcl.codec.hex.fromBits(sjcl.hash.sha256.hash(password.value));
            var xhttp = new XMLHttpRequest();
            xhttp.onreadystatechange = function(){
                if(this.readyState===4&&this.status===500){
                    alert("An error occurred. Pleasy try again later.");
            ...
            xhttp.open("POST","http://127.0.0.1:8080/tudo/api/users/",true);
    ...
    username.onchange = usernameCheck;
    password.onchange = function(){passwordCheck();password2Check();};
    password2.onchange = password2Check;
    registerForm.onsubmit = function(e){register(e)};
</script>
</body>
</html>
